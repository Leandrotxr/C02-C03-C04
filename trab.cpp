...
int verarvore(treenodeptr arvore, double x, double y){
	...
	if (arvore != NULL) {
		...
		// Chama a funcao para os nos filhos
			verarvore(arvore->esq, x, y);
			verarvore(arvore->dir, x, y);
    }
...
void mapaMenu() {
    ...
    while (ligado) {
        ...
        cout << "4 - Exibir a cidade mais proxima" << endl;
        cout << "5 - Exibir os pokemons que podem ser encontradas na cidade desejada" << endl;
        cout << "6 - Sair" << endl;
        ...
        switch (aux) {
            ...
            case 4:
                ...
                cout << "\nDigite o ID da cidade que voce esta: ";
                cin >> id;
